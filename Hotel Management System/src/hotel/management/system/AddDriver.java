...
public class AddDriver extends JFrame implements ActionListener {
    ...
    public AddDriver() {
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/valet.jpg"));
        ...
        comboBox_1 = new JComboBox<>(new String[]{"Available", "Not Available"});
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == b1) {
            try {
                ...
                String str = "INSERT INTO driver (name, age, gender, company, branch, availability, location) " +
                             "VALUES ('" + name + "', " + age + ", '" + gender + "', '" + company + "', '" + branch + "', '" + available + "', '" + location + "')";
